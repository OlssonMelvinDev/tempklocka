...
# LED-MATRISER (ENBART FÖR FÖRSTA GENERATION KRETSKORT)

hour_leds = [
    [10,11,28,29,50,51],  # ETT
    [12,13,26,27,52,53],  # TVÅ
    [14,15,24,25,54,55],  # TRE
    [100,101,116,117,130,131,142,143],  # FYRA
    [114,115,132,133,140,141],  # FEM
    [16,17,22,23,56,57],  # SEX
    [118,119,128,129,144,145],  # SJU
    [62,63,78,79,84,85,94,95],  # ÅTTA
    [18,19,20,21,58,59],  # NIO
    [120,121,126,127,146,147],  # TIO
    [60,61,80,81,82,83,96,97],  # ELVA
    [98,99,122,123,124,125,148,149]  # TOLV
]

word_leds = [
    [0,1,38,39,40,41,70,71,72,73,86,87,88,89,106,107,136,137],  # KLOCKAN ÄR
    [2,3,36,37,42,43,110,111],  # FEM I
    [90,91,104,105,108,109,110,111],  # TIO I
    [4,5,34,35,44,45,68,69,74,75,110,111],  # KVART I
    [6,7,32,33,46,47,66,67,76,77,110,111],  # TJUGO I
    [2,3,36,37,42,43,110,111,102,103,112,113,134,135,138,139],  # FEM I HALV
    [102,103,112,113,134,135,138,139],  # HALV
    [2,3,36,37,42,43,8,9,30,31,48,49,64,65,102,103,112,113,134,135,138,139],  # FEM ÖVER HALV
    [2,3,36,37,42,43,8,9,30,31,48,49,64,65],  # FEM ÖVER
    [90,91,104,105,108,109,8,9,30,31,48,49,64,65],  # TIO ÖVER
    [4,5,34,35,44,45,68,69,74,75,8,9,30,31,48,49,64,65],  # KVART ÖVER
    [6,7,32,33,46,47,66,67,76,77,8,9,30,31,48,49,64,65]  # TJUGO ÖVER
]
