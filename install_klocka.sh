...
sudo curl -o klockakod_v1.py https://raw.githubusercontent.com/OlssonMelvinDev/tempklocka/refs/heads/main/klockakod_v1.py
sudo chmod +x klockakod_v1.py
...
[Service]
ExecStart=/usr/bin/python3 /opt/klocka-skript/klockakod_v1.py
